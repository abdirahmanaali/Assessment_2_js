...
//CODE HERE
const empOne = new Employee("Jess", "weekends morning, weekends afternoon");
/*
...
//CODE HERE
const manager = new Manager("michael", "weekday nights, weekday afternoon", [
    "alice",
    "Sergio ",
  ]);
